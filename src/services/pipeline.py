...
from src.extraction.downloaders.base import AbstractDownloader
from src.extraction.downloaders.bulk import BulkDownloader
from src.extraction.downloaders.incremental import IncrementalDownloader
from src.extraction.downloaders.document import DocumentDownloader
from src.extraction.parsers.base import AbstractParser
from src.extraction.parsers.json import JSONParser, ParseResult as JSONParseResult
from src.extraction.parsers.index import IndexParser, ParseResult as IndexParseResult
from src.extraction.parsers.html import HTMLMetadataParser  # Import the new parser
